...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, LocalDate.parse("21/03/2018", fmt), "Partiu viagem", "Vou viajar. Bj", user1);
		Post post2 = new Post(null, LocalDate.parse("03/07/2004", fmt), "Bom dia!", "Acordei.", user1);
